$(document).ready(function() {
    ...
    var clickhandlers = [
        ...
        function(e) {
            ...
            if ($("#togglenav").is(":visible")) {
                $.smoothScroll({ scrollElement: $(document.body), scrollTarget: '#sidenavigation_wrapper', offset: -45, speed: 600 });
            } else {
                $.smoothScroll({ scrollElement: $(document.body), scrollTarget: target, offset: -80, speed: 600 });
            }
        ...
        function(f) {
            ...
            $.smoothScroll({ 
                scrollElement: 
                    $(document.body), scrollTarget: '#topbar', offset: 0, afterScroll: function() {
                        $(target).slideToggle( "fast" );
                        $(".side_nav").removeClass('single');
                        $(self).removeClass('active');
                        $('.insert_form[data-form=' + form + ']').hide();
                    } 
            });
        }
    ];
